...
namespace NEA
{
    public partial class NEA_Proj : Form
    {
        ...
        private void GeneratePlanets()
        {
            ...
            if (SpaceStationExists == 0 || SpaceStationExists == 1 || SpaceStationExists == 2)
            {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                GroupX.Add(new Buffer { X = buffers[i].X });
                GroupY.Add(new Buffer { Y = buffers[i].Y });

                for (int n = 1; n < GroupX.Count; n++)
                {
                ...
                for (int j = 0; j < PlanetInfo.Count(); j++)
                {
            ...
            {
                positions.Add(new Position() { X = CurrentGridPosition[0], Y = CurrentGridPosition[1], Planets = PlanetsInfo });
            }
            else
            {
            ...
            if (AsteroidFieldExists == 0 || AsteroidFieldExists == 1)
            {
                ...
                tmrUnlocked.Start();
                AsteroidFieldFound = true;
            }
            Invalidate();
        }

        //----------------EXISTING PLANET GENERATION----------------//
        private void GenerateExistingPlanets(int radius, int PosX, int PosY, int color1, int color2, int color3)
        {
            Graphics g = Graphics.FromImage(DrawingArea);
            brush.Color = Color.White;
        ...
        private void GenerateAsteroidField()
        {
            ...
            for (int a = 0; a < 10; a++)
            {
                ...
                Point p1 = new Point(rand.Next(0, DrawingArea.Width), rand.Next(0, DrawingArea.Height));
                ...
                Point[] AsteroidBot = { p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11 };
                ...
                Point[] AsteroidTop = { a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11 };

                g.FillPolygon(brush, AsteroidBot);
                g.FillPolygon(brush, AsteroidTop);
            }
        }
        ...
        {
            if (Ship1.Location.Y == 40 || Ship1.Location.Y == 41 || Ship1.Location.Y == 39 || Ship1.Location.Y == 42 || Ship1.Location.Y == 38 || Ship1.Location.Y == 43 || Ship1.Location.Y == 37 || Ship2.Location.Y == 40 || Ship2.Location.Y == 41 || Ship2.Location.Y == 39 || Ship2.Location.Y == 42 || Ship2.Location.Y == 38 || Ship2.Location.Y == 43 || Ship2.Location.Y == 37 || Ship3.Location.Y == 40 || Ship3.Location.Y == 41 || Ship3.Location.Y == 39 || Ship3.Location.Y == 42 || Ship3.Location.Y == 38 || Ship3.Location.Y == 43 || Ship3.Location.Y == 37 || Ship4.Location.Y == 40 || Ship4.Location.Y == 41 || Ship4.Location.Y == 39 || Ship4.Location.Y == 42 || Ship4.Location.Y == 38 || Ship4.Location.Y == 43 || Ship4.Location.Y == 37)
            {
            ...
            else if (Ship1.Location.X == 40 || Ship1.Location.X == 41 || Ship1.Location.X == 39 || Ship1.Location.X == 42 || Ship1.Location.X == 38 || Ship1.Location.X == 43 || Ship1.Location.X == 37 || Ship2.Location.X == 40 || Ship2.Location.X == 41 || Ship2.Location.X == 39 || Ship2.Location.X == 42 || Ship2.Location.X == 38 || Ship2.Location.X == 43 || Ship2.Location.X == 37 || Ship3.Location.X == 40 || Ship3.Location.X == 41 || Ship3.Location.X == 39 || Ship3.Location.X == 42 || Ship3.Location.X == 38 || Ship3.Location.X == 43 || Ship3.Location.X == 37 || Ship4.Location.X == 40 || Ship4.Location.X == 41 || Ship4.Location.X == 39 || Ship4.Location.X == 42 || Ship4.Location.X == 38 || Ship4.Location.X == 43 || Ship4.Location.X == 37)
            {
            ...
            else if (Ship1.Location.Y == 695|| Ship1.Location.Y == 694 || Ship1.Location.Y == 696 || Ship1.Location.Y == 693 || Ship1.Location.Y == 697 || Ship1.Location.Y == 692 || Ship1.Location.Y == 698 || Ship2.Location.Y == 695 || Ship2.Location.Y == 694 || Ship2.Location.Y == 696 || Ship2.Location.Y == 693 || Ship2.Location.Y == 697 || Ship2.Location.Y == 692 || Ship2.Location.Y == 698 || Ship3.Location.Y == 695 || Ship3.Location.Y == 694 || Ship3.Location.Y == 696 || Ship3.Location.Y == 693 || Ship3.Location.Y == 697 || Ship3.Location.Y == 692 || Ship3.Location.Y == 698 || Ship4.Location.Y == 695 || Ship4.Location.Y == 694 || Ship4.Location.Y == 696 || Ship4.Location.Y == 693 || Ship4.Location.Y == 697 || Ship4.Location.Y == 692 || Ship4.Location.Y == 698)
            {
                CurrentGridPosition[1] -= 1;
                SpaceStation.Visible = false;
            ...
            else if (Ship1.Location.X == 695 || Ship1.Location.X == 694 || Ship1.Location.X == 696 || Ship1.Location.X == 693 || Ship1.Location.X == 697 || Ship1.Location.X == 692 || Ship1.Location.X == 698 || Ship2.Location.X == 695 || Ship2.Location.X == 694 || Ship2.Location.X == 696 || Ship2.Location.X == 693 || Ship2.Location.X == 697 || Ship2.Location.X == 692 || Ship2.Location.X == 698 || Ship3.Location.X == 695 || Ship3.Location.X == 694 || Ship3.Location.X == 696 || Ship3.Location.X == 693 || Ship3.Location.X == 697 || Ship3.Location.X == 692 || Ship3.Location.X == 698 || Ship4.Location.X == 695 || Ship4.Location.X == 694 || Ship4.Location.X == 696 || Ship4.Location.X == 693 || Ship4.Location.X == 697 || Ship4.Location.X == 692 || Ship4.Location.X == 698)
            {
                CurrentGridPosition[0] += 1;
                SpaceStation.Visible = false;
            ...
            CoordinatesPosX.Text = System.Convert.ToString(CurrentGridPosition[0]);
            CoordinatesPosY.Text = System.Convert.ToString(CurrentGridPosition[1]);
        }

        //----------------------PLANET DETAILS----------------------//
        private void DisplayPlanetDetails()
        {
            Graphics g = Graphics.FromImage(DrawingArea);
            ...
            if (IsDisplayed == false)
            {
                ...
                if ((LandPercentage >= 30 && LandPercentage <= 70) && (WaterPercentage >= 30 && WaterPercentage <= 70) && temp <= 30 && temp >= -30 && minerals == 1 && gases == 1 && population >= 3)
                {
                    InhabitableText.Text = "Yes";
                    InhabitableText.ForeColor = Color.Green;
                    if (InhabitableCounter == 0)
                    {
                        ShipUnlockedTitle.Visible = true;
                        InhabitableCounter += 1;
                    }
                    tmrUnlocked.Start();
                    InhabitablePlanetFound = true;
                }
                else
                {
        ...
        //-----------------------MOVE PLAYER------------------------//
        private void tmrForwardTick(object sender, EventArgs e)
        {
            if (CurrentShip == 1)
            {
                Ship1.Top -= 2;
        ...
        private void Ship1KeyUp(object sender, KeyEventArgs e)
        {
            if (UsingArrows == false)
            {
                if (e.KeyCode == Keys.W)
